...
class Cubes {
    ...
    createCubes() {
        ...
        this.bufferGeometry = new THREE.TorusBufferGeometry(0.2, 0.09, 20, 100)
        ...
        this.uniforms = {
            ...
            uColorArray: {
                type: 'v3v',
                value: [new THREE.Color(0xe89ba8), new THREE.Color(0x9dd1d1)],
            },
            uFogColor: { type: 'v3', value: new THREE.Color(0xebf5bd) },
            uCameraDirection: {
                type: 'v3v',
            ...
            uFogStart: { type: 'f', value: param.cube.FogStart.value },
            uFogEnd: { type: 'f', value: param.cube.FogEnd.value },
        }

        param.cube.FogStart.gui.onChange(val => {
            this.uniforms.uFogStart.value = val
        })
        param.cube.FogEnd.gui.onChange(val => {
